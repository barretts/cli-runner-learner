 ...
 */
import type { StateDiff, ToolState } from "../types.js";
...
export declare function isParserFailure(v: TaskResult | ParserFailure): v is ParserFailure;
export declare const ORCH_FAILURE_CLASSES: readonly ["tool_crash", "timeout", "output_format", "verification_failed", "wrong_output", "prompt_gap", "transient_infra"];
